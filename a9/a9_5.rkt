...
;Transform all your serious function calls to our A-normal form style,
;by adding let* above your serious calls, and ensuring that the names
;of the actual parameters to the serious calls are *exactly* the names
